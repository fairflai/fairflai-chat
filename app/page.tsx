    ...
    <div className="min-h-screen bg-white flex flex-col">
        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Il tuo assistente personale</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-6">
            {messages.length === 0 && (
              <div className="text-center py-12">
                ...
                <h2 className="text-xl font-medium text-gray-900 mb-2">Ciao! Come posso aiutarti oggi?</h2>
                <p className="text-gray-500">Scrivi un messaggio per iniziare la conversazione</p>
              </div>
            )}
      ...
      <div className="border-t border-gray-200 bg-white/80 backdrop-blur-sm sticky bottom-0">
        <div className="max-w-4xl mx-auto px-4 py-4">
          ...
          <p className="text-xs text-gray-400 mt-2 text-center">Premi Invio per inviare il messaggio</p>
        </div>
      </div>
    </div>
  )
